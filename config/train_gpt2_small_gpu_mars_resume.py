# config for training GPT-2 on 8GB GPU with MARS optimizer - RESUME FROM CHECKPOINT
# Use this config to continue training from checkpoint with MARS optimizer
